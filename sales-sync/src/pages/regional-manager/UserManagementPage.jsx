...
import { UserPlus, Edit, Trash, Mail, Phone, BarChart2, Target, Users, Map } from 'lucide-react';
...
const UserManagementPage = () => {
  ...
  const [activeTab, setActiveTab] = useState('areaManagers');
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedUser) {
      ...
      if (formData.role === ROLES.AREA_MANAGER) {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-1">Manage area managers, team leaders, and agents in your region</p>
          </div>
          <div className="mt-4 md:mt-0 flex space-x-2">
            <Button onClick={() => handleAddUser(ROLES.AREA_MANAGER)}>
              <UserPlus className="h-4 w-4 mr-2" />
              Add Area Manager
            </Button>
            <Button variant="outline" onClick={() => handleAddUser(ROLES.TEAM_LEADER)}>
              <UserPlus className="h-4 w-4 mr-2" />
              Add Team Leader
            </Button>
          </div>
        ...
        {/* User Tables */}
        <Tabs defaultValue="areaManagers" onValueChange={setActiveTab}>
          ...
          <TabsContent value="areaManagers">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage area managers in your region
                </CardDescription>
              </CardHeader>
              <CardContent>
                <DataTable
          ...
          <TabsContent value="teamLeaders">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage team leaders in your region
                </CardDescription>
              </CardHeader>
              <CardContent>
                <DataTable
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-medium mb-2">Email Region</h3>
                <p className="text-sm text-gray-500 mb-4">
                  Send an email to all users in your region
                </p>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-medium mb-2">Assign Regional Goals</h3>
                <p className="text-sm text-gray-500 mb-4">
                  Set goals for your entire region
                </p>
                <Button variant="outline" className="w-full">
                  Manage Goals
                </Button>
